...
console.log(text[0]);
console.log(text[text.length - 1]);  //raide is galo 's'
...
console.log(k.indexOf('u', k.indexOf('s') + 1));
...
console.log(stringRepeat('dasdad', 9));
...
const s3 = String.fromCharCode(4654156464);
console.log(s3);

const s4 = String.fromCharCode(100000000000);
console.log(s4);
